...
Combining recovery-scored Gate 1 with that Gate 2 and the hardening protocol, **3 of 78 section-9 rows are H** (1 of 61 battery-tested, plus *Quecholli* and *Ixchel*). Twenty-five are C* / C+L*. *pul / puul* has a decode artifact (Gate 1 yes, Gate 2 fall, C*). The hardened set is: *xefe, Quecholli, Ixchel*. Demoted from the stopgap H list: *ascensionada, che', -en, Eztli Pilli, ich, k'áak', ki', kujkuali, máax, náach, Ti, u, waaj, Panquetzaliztli*. Earlier demotions that remain demoted: *akal, ek, tul, uch', xi, k'ux, ma*.
