...
- Statistical hardening (§17): 78 section-9 rows with H/C/S/O (L is a tag). Re-run hardened share 2/78 = 2.6% [0.7, 8.9] per token (2/69 distinct roots: *xefe*, *Quecholli*). Battery 1/61 / 1/52; enlarged Battery E base 2/64 / 2/55. *Ixchel* is C+L (Gate 1 herb ≠ approved theonym). The 2 x 10^-15 all-noise headline is withdrawn; re-run matched any-C p = 0.09494 / 0.3069, recovery-scored p = 1 / 0.9991. Companion: `analysis/STATISTICAL_SUMMARY.md`, `analysis/RESCORE_OUTPUT.md`.
