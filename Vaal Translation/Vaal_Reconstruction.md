...
**Does the published English come back from the Vaal?** Question: if someone translates the Vaal lines from dictionaries (with or without this project's method notes), how often do they match the published English? What was done: independent translations of the 51 published lines were scored against that frozen English. Separately, each line was graded by how settled its important words are (secure, working, fragile, or blocked by an opaque word), and each text was re-read without using that text's own words as support. Why it matters: high agreement would mean the English on the page is reproducible from the Vaal with this kit. Low agreement means those translations are not strongly recovered. Pessimistic: exact match with the published English is about 9-11%; **0 of 51 lines is fully secure**. Average: match or partial about 29%; about 24% of lines are working. Optimistic: match or partial still only about 35% at the upper 95% bound; working lines at most about 37%. Supporting numbers: method-notes arm, match 27/255 = 10.6% [7.4, 15.0], match+partial 75/255 = 29.4% [24.2, 35.3]; dictionaries-only arm, match 22/255 = 8.6% [5.8, 12.7], match+partial 72/255 = 28.2% [23.1, 34.1]. Line grades: 0/51 secure [0.0, 7.0], 12/51 working = 23.5% [14.0, 36.8], 38/51 fragile = 74.5% [61.1, 84.5], 1/51 blocked by an opaque word. Re-reading each text without its own words: 12/51 ok = 23.5% [14.0, 36.8], 33/51 ok or partial = 64.7% [51.0, 76.4]; Text 3 is the weakest fold (0/13 ok). Method notes do not raise agreement with the published English (the difference interval includes zero). They do cut clashes and raise abstentions. The honest unit of confidence is the individual token.
...
Recap only. Each check is introduced in full in §17.3-17.8. Pessimistic / average / optimistic readings use live interval endpoints or stricter-vs-looser criteria. No invented numbers.
...
**Line-level English.** Question: do independent translations match the published English? Pessimistic: exact match about 9-11%; **0/51 lines fully secure**. Average: match or partial about 29%; about 24% working. Optimistic: match or partial about 35% at the upper 95% bound; working about 37% at the upper 95% bound. Re-reading each text without its own words: pessimistic 14% ok; average 24% ok / 65% ok or partial; optimistic 76% ok or partial. Text 3 is 0/13 ok. Method notes do not raise agreement with the published English.
...
Pessimistic: exact match about 9-11% (dictionaries-only 8.6% [5.8, 12.7]; method-notes 10.6% [7.4, 15.0]); 0/51 fully secure [0.0, 7.0]. Average: match or partial about 29% (method-notes 29.4% [24.2, 35.3]; dictionaries-only 28.2% [23.1, 34.1]); working 23.5% [14.0, 36.8]. Optimistic: match or partial upper 95% bound 35.3%; working upper 95% bound 36.8%.
