...
# new semantic claims.
SENSE_GROUPS = [
    {"tree", "wood", "stick", "palo", "madera", "mazo"},
    {"absolutive", "predicative", "suffix", "person"},
    {"within", "inside", "into"},
    {"good", "worthy", "delicious", "sweet", "tasty", "pleasant", "bueno"},
    {"bite", "gnaw", "fierce", "pain", "hurt", "hate", "rancor", "ache", "chew"},
    {"who", "interrogative", "quien"},
    {"far", "distant", "lejos", "distante"},
    {"his", "her", "its", "possessive"},
    {"bread", "tortilla", "maize", "offering", "tamale", "pan", "wah"},
    {"chief", "commander", "boss", "jefe"},
    {"ascended", "risen", "ascension", "ascend", "rise"},
    {"fire", "fuego"},
    {"blood", "noble", "prince", "child", "sangre"},
    {"negation", "without", "negative", "particle"},
    {"optative", "hortative"},
    {"star", "black", "dark", "venus", "estrella"},
    ...
    {"life", "living"},
    {"bird", "pajaro", "ave", "spoonbill", "plumaje", "feather", "pluma"},
    {"throw", "cast", "hurl", "arrojar", "echar", "desechar"},
    {"rainbow", "arco", "iris", "deidad", "diosa", "goddess"},
]
