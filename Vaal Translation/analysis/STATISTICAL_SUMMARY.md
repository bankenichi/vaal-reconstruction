...
A replacement panel, analysts blinded to project English glosses and scored at analyst level from the start, is **pending** (`SYNTAX_EXPERIMENT_LOG_RERUN.md`). Do not fake p-values.
